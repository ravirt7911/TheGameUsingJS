...
const locations=[
  ...
  },
  {
    ...
    text:'You find a secret game.Pick a number above. 1 number willl be randomly choosen between 0,10.If number matches you win'
  }
...
function buyWeapon(){
  if(currentWeapon < weapons.length-1){
    ...
    text.innerText+= "In your inventory you have: "+ inventory;
      ...
      text.innerText+= "You dont have enough gold for a weapon";
